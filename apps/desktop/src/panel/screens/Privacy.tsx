    ...
    <div className="space-y-3">
      ...
      <Card>
        ...
        <Muted>
          ...
          fields outright. Maman can act in Chrome through the macOS Accessibility access it already
          observes with, which asks Chrome to expose the page; where Chrome declines, or for the
          most reliable results, pair the Chrome extension. Give the full address, including
          https://, because it is matched exactly: an org on its own subdomain has to be named as
          such.
        </Muted>
